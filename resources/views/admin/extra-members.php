<?php include './includes/header.php' ?>
		...
		<div class="member-entry">
			...
			<div class="member-details">
				<h4>
					<a href="extra-timeline.html">Johnnie Linton</a>
				</h4>
		...
		<div class="member-entry">
			...
			<div class="member-details">
				<h4>
					<a href="extra-timeline.html">Laura Fassett</a>
				</h4>
				...
				<div class="row info-list">
					...
					<div class="col-sm-4">
						<i class="entypo-briefcase"></i>
						Dental Surgery Doctor at <a href="#">Omni Realty</a>
					</div>
					
					<div class="col-sm-4">
						<i class="entypo-twitter"></i>
						<a href="#">@laurajFassett</a>
					</div>
					
					<div class="col-sm-4">
						<i class="entypo-facebook"></i>
						<a href="#">fb.me/Willne</a>
					</div>
		...
		<div class="member-entry">
			...
			<div class="member-details">
				<h4>
					<a href="extra-timeline.html">Joseph Lewis</a>
				</h4>
				...
				<div class="row info-list">
					...
					<div class="col-sm-4">
						<i class="entypo-mail"></i>
						<a href="#">JosephDLewis@dayrep.com</a>
					</div>
		...
		<div class="member-entry">
			...
			<div class="member-details">
				<h4>
					<a href="extra-timeline.html">Bruno Price</a>
				</h4>
				...
				<div class="row info-list">
					...
					<div class="col-sm-4">
						<i class="entypo-briefcase"></i>
						Offset lithographic press operator at <a href="#">Grodins</a>
					</div>
					...
					<div class="col-sm-4">
						<i class="entypo-mail"></i>
						<a href="#">JosephBrunoRPrice@heatkey.comm</a>
					</div>
		...
		<div class="member-entry">
			...
			<div class="member-details">
				<h4>
					<a href="extra-timeline.html">Jeannette Ferreri</a>
				</h4>
				...
				<div class="row info-list">
					...
					<div class="col-sm-4">
						<i class="entypo-briefcase"></i>
						Range conservationist at <a href="#">TheBottomHalf</a>
					</div>
					...
					<div class="col-sm-4">
						<i class="entypo-mail"></i>
						<a href="#">JeannetteMFerreri@dayrep.com</a>
					</div>
					
					<div class="col-sm-4">
						<i class="entypo-linkedin"></i>
						<a href="#">JeannetteMFerreri</a>
					</div>
