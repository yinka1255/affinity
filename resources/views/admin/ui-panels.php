		...
		<div class="row">
			...
			<div class="col-md-6">
				...
				<div class="panel minimal">
					...
					<!-- panel head -->
					<div class="panel-heading">
						<div class="panel-title">Minimal Panel with Icons</div>
						
						<div class="panel-options">
							<ul class="nav nav-tabs">
								<li class="active">
									<a href="#tab1" data-toggle="tab"><i class="entypo-target"></i></a>
								</li>
								
								<li>
									<a href="#tab2" data-toggle="tab"><i class="entypo-mail"></i></a>
								</li>
							</ul>
						</div>
					</div>
		...
		<div class="row">
			...
			<div class="col-md-6">
				...
				<div class="panel panel-invert" data-collapsed="0"><!-- setting the attribute data-collapsed="1" will collapse the panel -->
					...
					<!-- panel head -->
					<div class="panel-heading">
						<div class="panel-title">Inverted Panel (scrollable)</div>
		...
		<div class="row">
			<div class="col-md-12">
				...
				<div class="panel panel-default panel-shadow" data-collapsed="0"><!-- to apply shadow add class "panel-shadow" -->
					...
					<!-- panel head -->
					<div class="panel-heading">
						<div class="panel-title">Default Panel (shadow applied)</div>
