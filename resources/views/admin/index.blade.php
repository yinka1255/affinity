...
<link rel="alternate" href="https://demo.neontheme.com/assets/css/font-icons/entypo/css/entypo.css">
	<link rel="stylesheet" href="js/admin/jquery-ui/css/no-theme/jquery-ui-1.10.3.custom.min.css">
	...
	<link rel="stylesheet" href="css/admin/neon-core.css">
	<link rel="stylesheet" href="css/admin/neon-theme.css">
	<link rel="stylesheet" href="css/admin/neon-forms.css">
	<link rel="stylesheet" href="css/admin/custom.css">
<link rel="stylesheet" href="css/admin/font-icons/font-awesome/css/font-awesome.min.css">
...
<div class="page-container"><!-- add class "sidebar-collapsed" to close sidebar by default, "chat-visible" to make chat appear always -->
	...
	<link rel="stylesheet" href="js/admin/rickshaw/rickshaw.min.css">

	<!-- Bottom scripts (common) -->
	<script src="js/admin/gsap/TweenMax.min.js"></script>
	<script src="js/admin/jquery-ui/js/jquery-ui-1.10.3.minimal.min.js"></script>
	<script src="js/admin/bootstrap.js"></script>
	<script src="js/admin/joinable.js"></script>
	<script src="js/admin/resizeable.js"></script>
	<script src="js/admin/neon-api.js"></script>
	<script src="js/admin/jvectormap/jquery-jvectormap-1.2.2.min.js"></script>


	<!-- Imported scripts on this page -->
	<script src="js/admin/jvectormap/jquery-jvectormap-europe-merc-en.js"></script>
	<script src="js/admin/jquery.sparkline.min.js"></script>
	<script src="js/admin/rickshaw/vendor/d3.v3.js"></script>
	<script src="js/admin/rickshaw/rickshaw.min.js"></script>
	<script src="js/admin/raphael-min.js"></script>
	<script src="js/admin/morris.min.js"></script>
	<script src="js/admin/toastr.js"></script>
	<script src="js/admin/neon-chat.js"></script>


	<!-- JavaScripts initializations and stuff -->
	<script src="js/admin/neon-custom.js"></script>


	<!-- Demo Settings -->
	<script src="js/admin/neon-demo.js"></script>
