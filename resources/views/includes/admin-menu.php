...
<div class="profile clearfix">
              <div class="profile_pic">
                <img src="../../affinity/public/<?php echo $user->avatar; ?>" alt="..." class="img-circle profile_img" width="60px" height="60px">
              </div>
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-user"></i> Members <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="admin_guests">Guest Users</a></li>
                      <li><a href="admin_customers">Active Members</a></li>
                    </ul>
                  </li>
                  ...
                  <li><a><i class="fa fa-shopping-cart"></i> Tickets <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      ...
                      <li><a href="admin_airport_concierge">Airport Concierge</a></li>
                  ...
                  <li><a href="admin_subscriptions"><i class="fa fa-money"></i> Subscriptions </a>
                  </li>
              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                    <img src="../../affinity/public/<?php echo $user->avatar; ?>" alt=""><?php echo $user->name; ?>
