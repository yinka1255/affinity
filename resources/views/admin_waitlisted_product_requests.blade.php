  ...
  <head>
    ...
    <script>
      ...
      function openLink(data){
        location.href = "admin_comment/waitlisted_products/"+data.id;
      }
    </script>  
  </head>
                  ...
                  <div class="x_content">
                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered">
                      ...
                      @foreach ($waitlisted_product_requests as $key => $waitlisted_product_request) 
                        <tr>
                          <td>0000{!! $waitlisted_product_request->id !!}</td>
                          <td>
                          ...
                          <td>{!! $waitlisted_product_request->customer_id !!}</td>
                          ...
                          <td>
                            <button class="btn btn-default btn-success source" onclick='openLink(<?php echo json_encode($waitlisted_product_request); ?>)' ><i class="fa fa-external-link"></i></button>
                          </td>
                        </tr>
                      @endforeach  
                      </tbody>
