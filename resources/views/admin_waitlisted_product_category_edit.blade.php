          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-7 col-sm-7 col-xs-12">
                ...
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Edit <small>{!! $waitlisted_product_category->name !!}</small></h2>
                    <ul class="nav navbar-right panel_toolbox">
                      </li>
                      <li class="dropdown">
                        <a href="../admin_waitlisted_product_categories"><i class="fa fa-group"></i> List waitlisted_product_categories</a>
                      </li>
                    </ul>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
                    <form class="form-horizontal form-label-left" method="post" enctype="multipart/form-data" action="../admin_waitlisted_product_category_update">

                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-3">Name</label>
                        <div class="col-md-9 col-sm-9 col-xs-9">
                          <input type="text" name="name" value="{!! $waitlisted_product_category->name !!}" class="form-control" required>
                      ...
                      <input type="hidden" class="form-control" name="waitlisted_product_category_id" value="{!! $waitlisted_product_category->id !!}">
              ...
              {{--<div class="col-md-5">
                <div class="x_panel" style="height: 400px;overflow: auto !important;">
                  <div class="x_title">
                    <h2>Gallery <small>{!! $waitlisted_product_category->name !!}</small></h2>
                    <ul class="nav navbar-right panel_toolbox">
                      </li>
                      <li class="dropdown">
                        <a href="../admin_waitlisted_product_categories"><i class="fa fa-group"></i> List waitlisted_product_categories</a>
                  ...
                  <div class="x_content">
                    <div class="row">
                      <form id="uploadForm" action="../admin_upload_waitlisted_product_category_gallery" method="post" enctype="multipart/form-data">
                        <input type="file" id="avatar" style="visibility: hidden;" onchange="submitGallery()" name="avatar">
                        <input type="hidden" class="form-control" value="{!! $waitlisted_product_category->id !!}" name="waitlisted_product_category_id" required>
                      </form>
