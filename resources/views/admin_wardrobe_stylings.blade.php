                        ...
                        <div class="widget_summary">
                          ...
                          <div class="w_center w_55">
                            <div class="progress">
                              ...
                              <?php
                                $pending = 0;
                                foreach ($wardrobe_stylings as $my_wardrobe_stylings) {
                                  if($my_wardrobe_stylings->status == 'Pending'){
                                    $pending++;
                                  }
                                }  
                                if(count($wardrobe_stylings) > 0){
                                  echo ($pending/count($wardrobe_stylings)) * 100 ;
                                }?>%">
                                <span class="sr-only">
                                  0
                                </span>
                          ...
                          <div class="w_center w_55">
                            <div class="progress">
                              ...
                              <?php
                                $in_progress = 0;
                                foreach ($wardrobe_stylings as $my_wardrobe_stylings) {
                                  if($my_wardrobe_stylings->status == "In Progress"){
                                    $in_progress++;
                                  }
                                }  
                                if(count($wardrobe_stylings) > 0){
                                  echo ($in_progress/count($wardrobe_stylings)) * 100 ;
                                }?>%">
                          ...
                          <div class="w_center w_55">
                            <div class="progress">
                              ...
                              <?php
                                $resolved = 0;
                                foreach ($wardrobe_stylings as $my_wardrobe_stylings) {
                                  if($my_wardrobe_stylings->status == "Resolved"){
                                    $resolved++;
                                  }
                                }  
                                if(count($wardrobe_stylings) > 0){
                                  echo ($resolved/count($wardrobe_stylings)) * 100 ;
                                }?>%">
                          ...
                          <div class="w_center w_55">
                            <div class="progress">
                              ...
                              <?php
                                $unresolved = 0;
                                foreach ($wardrobe_stylings as $my_wardrobe_stylings) {
                                  if($my_wardrobe_stylings->status == "Unresolved"){
                                    $unresolved++;
                                  }
                                }  
                                if(count($wardrobe_stylings) > 0){
                                  echo ($unresolved/count($wardrobe_stylings)) * 100 ;
                                }?>%">
                                <span class="sr-only">60% Complete</span>
                              </div>
                            </div>
